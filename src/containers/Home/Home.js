          ...
          <div>
            <Helmet
              ...
              meta={[
                {
                  name: 'description',
                  content: 'North Ryde, Ryde, Macquarie park, Top Ryde, Marsfield, Macquarie Centre'
                }
              ]}
            />
            {/* page.image &&
                ...
                <div className="row text-center">
                  <div className="col-md-4">
                    ...
                    <p className="text-muted">
                      Macquarie Health Professionals is a leading practice in Sydney's Macquarie Park
                  ...
                  {page.home_teaser &&
                    page.home_teaser.map(item => (
                      <div className="col-md-4 col-sm-6 portfolio-item">
                        <a className="portfolio-link tmp bg-white h-100" href={Link.url(item.url, linkResolver)}>
                  ...
                  <div className={styles.mapWrapper}>
                    ...
                    >
                      <AnyReactComponent
                        lat={-33.776752}
                        lng={151.120515}
                        text="Macquarie Health Professionals"
                        styles={styles}
                      />
                    </GoogleMapReact>
                  </div>
